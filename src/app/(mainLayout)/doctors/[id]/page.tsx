...
export default async function DoctorDetailsPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
            <div className="md:col-span-2 space-y-8">
                ...
                <Tabs defaultValue="About" className="border-b flex gap-8 text-sm font-semibold">
                    <TabsList className={'border-b-2 w-full flex items-start'}>
                        <TabsTrigger value="About" className=" cursor-pointer border-none">About</TabsTrigger>
                        <TabsTrigger value="Feedback" className=" cursor-pointer border-none">Feedback</TabsTrigger>
                    </TabsList>
                    <TabsContent value="About">
                        ...
                        <div className="border border-slate-100 rounded-3xl p-6 bg-white space-y-6 shadow-xl shadow-slate-100/70">
